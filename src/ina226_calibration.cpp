...
void setup()
{
  ...
  float current_LSB_mA = 0.025;              /* current_LSB_mA (Current Least Significant Bit in milli Amperes). Recommended values: 0.050, 0.100, 0.250, 0.500, 1, 2, 2.5 (in milli Ampere units) */
  float current_zero_offset_mA = -0.013 ;         /* current_zero_offset_mA (Current Zero Offset in milli Amperes, default = 0) */
  uint16_t bus_V_scaling_e4 = 10004;        /* bus_V_scaling_e4 (Bus Voltage Scaling Factor, default = 10000) */
